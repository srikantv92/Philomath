...
public class Promote {
	...
	public void getDetails(String email, String course) {
		...
		try {
			...
			while (rs.next()) {
				...
				details = details + "<br> Availability: " + (rs.getString("availability").isEmpty()
						? "Contact Tutor for Availability Details" : rs.getString("availability"));
				details = details + "<br> Pricing: " + (rs.getString("pricing").isEmpty()
						? "Contact Tutor for Pricing Details" : rs.getString("pricing"));
			}
	...
	public void sendSensitivityEmail(String to) throws RuntimeException {
		...
		String messagetext = "Hello Students! <br><br> A course has been added in PhiloMath Application. Please find the details of course below -<br>"
				+ details;

		final String username = "srikant.vadrevu@gmail.com";// change
															// accordingly
